...
LOCAL_MODULE_PATH := $(PRODUCT_OUT)$(HAL_BM_SOURCE_WIFI_PREFIX)/aosp
endif
...
HOSTAPD_AOSP:
	...
	$(hide) ln -sf $(HAL_BM_TARGET_WIFI)/hostapd $(PRODUCT_OUT)/system/bin/hostapd
	$(hide) ln -sf $(HAL_BM_TARGET_WIFI)/hostapd_cli $(PRODUCT_OUT)/system/bin/hostapd_cli
ALL_DEFAULT_INSTALLED_MODULES += HOSTAPD_AOSP
endif
