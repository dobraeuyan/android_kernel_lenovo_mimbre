...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = ..\..\test\aliens-1.0.2\aliens.exe
OBJFILES = ..\..\test\aliens-1.0.2\aliens.obj
RESFILES = 
MAINSOURCE = aliens.bpf
RESDEPEN = $(RESFILES)
LIBFILES = ..\lib\SDLmain.lib ..\lib\SDL.lib ..\lib\SDL_mixer.lib ..\lib\SDL_image.lib
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
...
INCLUDEPATH = ..\..\test\aliens-1.0.2;..\..\include;$(BCB)\include;$(BCB)\include\vcl;..\..\SDL_image-1.2.2;..\..\SDL_mixer-1.2.4
LIBPATH = ..\..\test\aliens-1.0.2;..\..\test;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;..\..\test\aliens-1.0.2
PATHASM = .;
PATHPAS = .;
PATHRC = .;
PATHOBJ = .;$(LIBPATH)
...
IDLCFLAGS = -I..\..\test\aliens-1.0.2 -I..\..\include -I$(BCB)\include \
    -I$(BCB)\include\vcl -I..\..\SDL_image-1.2.2 -I..\..\SDL_mixer-1.2.4 \
