...
static struct semaphore help_sem = __SEMAPHORE_INITIALIZER(help_sem, 0);
...
#define try_request_help()	\
	rebalance(REQUEST)
#define try_reply_help()	\
	rebalance(REPLY)
#define try_cancel_help()	\
