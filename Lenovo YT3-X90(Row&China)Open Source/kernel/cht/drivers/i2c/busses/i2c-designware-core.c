...
#define BLDIII_FRONT_CAMERA_I2C_BUS_NO 2
#define BLDIII_BACK_CAMERA_I2C_BUS_NO 3
...
int i2c_dw_init(struct dw_i2c_dev *dev)
{
	...
	if (dev->sda_hold_time) {
       ...
       if ((dev->adapter.nr == BLDIII_BACK_CAMERA_I2C_BUS_NO) || (dev->adapter.nr == BLDIII_FRONT_CAMERA_I2C_BUS_NO)) {
               /*adjust SDA delay to 300ms for back and front camera at 400KHZ*/
               dw_writel(dev, 0x1e, 0x7c);
       }
//liulc1  add 200ns
