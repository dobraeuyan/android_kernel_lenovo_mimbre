...
static const struct ar1335_reg analog_setup_recommended[] = {
	...
	{AR1335_16BIT, {0x3EDA}, 0xF896},//Rst under range
	{AR1335_16BIT, {0x3EDC}, 0x508C},//Sig under range, rst over range
...
//Scale Configuration
	{AR1335_16BIT, {0x0400}, 0x0000}, //Scaling Enabling: 0= disable, 1= x-dir
	{AR1335_16BIT, {0x0404}, 0x0010}, //Scale_M = 32

//Timing Configuration
	{AR1335_16BIT, {0x0342}, 0x1230},//LINE_LENGTH_PCK 2304
	{AR1335_16BIT, {0x0340}, 0x0898},//FRAME_LENGTH_LINES 3178
