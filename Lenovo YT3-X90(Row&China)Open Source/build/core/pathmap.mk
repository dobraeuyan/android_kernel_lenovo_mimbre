...
# Lenovo-sw SystemTheme liqf1 add 20150122 begin ,support LenovoThemePackage LVPCCR-22*/
### Added by wangdfc for LVP Components ### PATCHROM-455 Start
# A directory name list of Lenovo customized widget projects
LENOVO_WIDGET_PROJECT_NAME_LIST := $(shell ls frameworks/base/LenovoThemePackage/android_4.4/extapi/java)
FRAMEWORKS_BASE_SUBDIRS += LenovoThemePackage/android_4.4/extapi/java
FRAMEWORKS_BASE_SUBDIRS += $(foreach LENOVO_WIDGET_PROJECT_NAME, $(LENOVO_WIDGET_PROJECT_NAME_LIST), $(addsuffix /src, LenovoThemePackage/android_4.4/extapi/java/$(LENOVO_WIDGET_PROJECT_NAME)))
### Added by wangdfc for LVP Components ### PATCHROM-455 End
# Lenovo-sw SystemTheme liqf1 add 20150122 end ,LVPCCR-22*/
