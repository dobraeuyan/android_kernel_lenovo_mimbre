...
#Lenovo-SW VIBEUI_SAFE huangzb1 added 2014-12-26 begin , support app permission controll PATCHROM
LOCAL_STATIC_LIBRARIES += libapppc
#Lenovo-SW VIBEUI_SAFE huangzb1 added 2014-12-26 end , support app permission controll PATCHROM
ifeq ($(strip $(BOARD_CHARGER_ENABLE_SUSPEND)),true)
