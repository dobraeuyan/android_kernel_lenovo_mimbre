...
/* Generated by utils/src/sep_rpc_gen/sep_rpc_gen.py@3343 at 2014-08-21 19:28:34.459000 */
/******************************************************************** 
...
typedef struct SepRpc__DX_ECPKI_ELGAMAL_EncryptParams {
	...
	/*le32*/DxBool_t isExactMessageInSize;
	/* Input/Output */
...
#define SEPRPC_FUNC_ID__DX_ECPKI_ELGAMAL_Decrypt 12
/*
...
#define SEPRPC_MEMREF_NUM__DX_ECPKI_ELGAMAL_Decrypt 0
#if SEPRPC_MEMREF_NUM__DX_ECPKI_ELGAMAL_Decrypt > SEP_RPC_MAX_MEMREF_PER_FUNC
#error SEPRPC_MEMREF_NUM__DX_ECPKI_ELGAMAL_Decrypt is more than SEP_RPC_MAX_MEMREF_PER_FUNC
#endif

typedef struct SepRpc__DX_ECPKI_ELGAMAL_DecryptParams {
	uint32_t num_of_memrefs; /* Number of elements in the memRef array */
	/* Input */
	...
	CRYSError_t _funcRetCode;
} SepRpc__DX_ECPKI_ELGAMAL_DecryptParams_s;
...
typedef struct SepRpc_CRYS_ECDH_SVDP_DHParams {
	...
	/* Output */
	DxUint8_t SharedSecretValue_ptr[2*4*CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS];
...
#define SEPRPC_FUNC_ID_CRYS_ECPKI_GenKeyPairUserSeed 16
/*
...
#define SEPRPC_MEMREF_NUM_CRYS_ECPKI_GenKeyPairUserSeed 0
#if SEPRPC_MEMREF_NUM_CRYS_ECPKI_GenKeyPairUserSeed > SEP_RPC_MAX_MEMREF_PER_FUNC
#error SEPRPC_MEMREF_NUM_CRYS_ECPKI_GenKeyPairUserSeed is more than SEP_RPC_MAX_MEMREF_PER_FUNC
#endif

typedef struct SepRpc_CRYS_ECPKI_GenKeyPairUserSeedParams {
	uint32_t num_of_memrefs; /* Number of elements in the memRef array */
	/* Input */
	/*le32*/CRYS_ECPKI_DomainID_t DomainID;
	DxUint32_t  TempData_ptr_size;
	DxUint8_t userSeed_ptr[CRYS_ECPKI_USER_SEED_SIZE_IN_BYTES];
	DxUint8_t userSeed_ptr_null_flag;
	/*le32*/DxUint32_t userSeedSizeInBytes;
	/* Output */
	CRYS_ECPKI_UserPrivKey_t __UserPrivKey_ptr;
	DxUint8_t __UserPrivKey_ptr_null_flag;
	CRYS_ECPKI_UserPublKey_t __UserPublKey_ptr;
	DxUint8_t __UserPublKey_ptr_null_flag;
	CRYSError_t _funcRetCode;
} SepRpc_CRYS_ECPKI_GenKeyPairUserSeedParams_s;
