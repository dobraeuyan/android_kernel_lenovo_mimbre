...
/* Generated by utils/src/sep_rpc_gen/sep_rpc_gen.py@3343 at 2014-08-21 19:28:53.984000 */
/******************************************************************** 
	...
	DxUint8_t Output_ptr[])
{
	...
	if (Output_ptr == NULL) {
		params.Output_ptr_null_flag = 1;
	} else if (RndSize <= (sizeof(params.Output_ptr) / sizeof(params.Output_ptr[0]))) { // INTEL change; Klockwork fix
