...
/* Generated by utils/src/sep_rpc_gen/sep_rpc_gen.py@3343 at 2014-10-08 18:23:04.249000 */
/******************************************************************** 
	...
	DxUint8_t Output_ptr[])
{
	...
	} else if (UserPubKey_ptr != NULL) {    // INTEL change; Klockwork fix
	...
	DxUint8_t Output_ptr[])
{
	...
	if (Output_ptr == NULL) {
		params.Output_ptr_null_flag = 1;
	} else if (UserPrivKey_ptr != NULL) {   // INTEL change; Klockwork fix
		/* Verify array size of Output_ptr */
	...
	CRYS_PKCS1_version PKCS1_ver)
{
	...
	if (Output_ptr == NULL) {
		params.Output_ptr_null_flag = 1;
	} else if (OutputSize_ptr != NULL) {    // INTEL change; Klockwork fix
		/* Verify array size of Output_ptr */
	...
	if (Output_ptr == NULL) {
		params.Output_ptr_null_flag = 1;
	} else if (OutputSize_ptr != NULL && (*OutputSize_ptr <= (sizeof(params.Output_ptr) / sizeof(params.Output_ptr[0])))) { // INTEL change; Klockwork fix
	...
	CRYS_PKCS1_version PKCS1_ver)
{
	...
	params.rsaHashMode = cpu_to_le32(rsaHashMode);
	params.MGF = cpu_to_le32(MGF);
	...
	DxUint16_t *ModulusSize_ptr)
{
	...
	if (Exponent_ptr == NULL) {
		params.Exponent_ptr_null_flag = 1;
	} else if (ExponentSize_ptr != NULL) {  // INTEL change; Klockwork fix
		/* Verify array size of Exponent_ptr */
	...
	if (Modulus_ptr == NULL) {
		params.Modulus_ptr_null_flag = 1;
	} else if (ModulusSize_ptr != NULL) {   // INTEL change; Klockwork fix
		/* Verify array size of Modulus_ptr */
	...
	if (Exponent_ptr == NULL) {
		params.Exponent_ptr_null_flag = 1;
	} else if (ExponentSize_ptr != NULL && (*ExponentSize_ptr <= (sizeof(params.Exponent_ptr) / sizeof(params.Exponent_ptr[0])))) { // INTEL change; Klockwork fix
	...
	if (Modulus_ptr == NULL) {
		params.Modulus_ptr_null_flag = 1;
	} else if (ModulusSize_ptr != NULL && (*ModulusSize_ptr <= (sizeof(params.Modulus_ptr) / sizeof(params.Modulus_ptr[0])))) { // INTEL change; Klockwork fix
	...
	DxUint16_t DataOutSize)
{
	...
	if (Output_ptr == NULL) {
		params.Output_ptr_null_flag = 1;
	} else if (DataOutSize <= (sizeof(params.Output_ptr) / sizeof(params.Output_ptr[0]))) { // INTEL change; Klockwork fix
