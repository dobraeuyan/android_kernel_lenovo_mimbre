...
/* Generated by utils/src/sep_rpc_gen/sep_rpc_gen.py@3343 at 2014-08-21 19:28:21.455000 */
/******************************************************************** 
	...
	DxUint32_t *WrapDataLen_ptr)
{
	...
	} else if (WrapDataLen_ptr != NULL) {   // INTEL change; Klockwork fix
	...
	DxUint32_t *DataOutLen_ptr)
{
	...
	} else if (DataOutLen_ptr != NULL) {    // INTEL change; Klockwork fix
