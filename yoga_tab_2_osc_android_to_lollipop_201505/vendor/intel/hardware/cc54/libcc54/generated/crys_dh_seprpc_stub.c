...
/* Generated by utils/src/sep_rpc_gen/sep_rpc_gen.py@3343 at 2014-08-21 19:28:27.994000 */
/******************************************************************** 
	...
	DxUint16_t *ClientPubSize_ptr)
{
	...
	} else if (ClientPrvKeySize_ptr != NULL) {  // INTEL change; Klockwork fix
	...
	} else if (ClientPubSize_ptr != NULL) { // INTEL change; Klockwork fix
	...
	if (ClientPrvKey_ptr == NULL) {
		params.ClientPrvKey_ptr_null_flag = 1;
	} else if (ClientPrvKeySize_ptr != NULL && (*ClientPrvKeySize_ptr <= (sizeof(params.ClientPrvKey_ptr) / sizeof(params.ClientPrvKey_ptr[0])))) { // INTEL change; Klockwork fix
	...
	if (ClientPub1_ptr == NULL) {
		params.ClientPub1_ptr_null_flag = 1;
	} else if (ClientPubSize_ptr != NULL && (*ClientPubSize_ptr <= (sizeof(params.ClientPub1_ptr) / sizeof(params.ClientPub1_ptr[0])))) {   // INTEL change; Klockwork fix
	...
	DxUint16_t *SecretKeySize_ptr)
{
	...
	} else if (SecretKeySize_ptr != NULL) { // INTEL change; Klockwork fix
	...
	if (SecretKey_ptr == NULL) {
		params.SecretKey_ptr_null_flag = 1;
	} else if (SecretKeySize_ptr != NULL && (*SecretKeySize_ptr <= (sizeof(params.SecretKey_ptr) / sizeof(params.SecretKey_ptr[0])))) { // INTEL change; Klockwork fix
	...
	DxUint16_t SecretKeyingDataSize)
{
	...
	if (SecretKeyingData_ptr == NULL) {
		params.SecretKeyingData_ptr_null_flag = 1;
	} else if (SecretKeyingDataSize <= (sizeof(params.SecretKeyingData_ptr) / sizeof(params.SecretKeyingData_ptr[0]))) {    // INTEL change; Klockwork fix
	...
	CRYS_DHKGData_t *DHKGbuff_ptr)
{
	...
	} else if (generGsizeBytes_ptr != NULL) {   // INTEL change; Klockwork fix
	...
	} else if (JsizeBytes_ptr != NULL) {    // INTEL change; Klockwork fix
