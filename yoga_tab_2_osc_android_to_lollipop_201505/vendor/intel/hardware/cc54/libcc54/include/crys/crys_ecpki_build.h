...
/**
   ...
   @param[in]  PublKeyIn_ptr   - The pointer to public key data.
   @param[in]  PublKeySizeInBytes - Size of public key data in bytes (according to EC domain),
   ...
   @param[out] UserPublKey_ptr - A pointer to the public key structure.
