...
enum dxdi_sym_cipher_type {
	...
	DXDI_SYMCIPHER_AES_XXX  = _DXDI_SYMCIPHER_AES_FIRST,        // INTEL change - begin
	...
	DXDI_SYMCIPHER_AES_XTS  = _DXDI_SYMCIPHER_AES_FIRST + 4,    // INTEL change - end
...
struct dxdi_sym_cipher_props {
	...
	union { /* cipher specific properties */
		...
		uint64_t __assure_64b_union_alignment;
...
struct dxdi_sepapp_command_invoke_params {
	dxdi_sepapp_uuid_t app_uuid; /*[in]*/  //INTEL Change
	dxdi_sepapp_session_id_t session_id; /*[in]*/
