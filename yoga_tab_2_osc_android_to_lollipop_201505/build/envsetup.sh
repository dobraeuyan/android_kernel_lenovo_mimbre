...
addcompletions
export DOLBY_UDC=true
export DOLBY_MKV=true
export DOLBY_DAP=true
export DOLBY_DAP_OPENSLES=true
export DOLBY_DAP_BYPASS_SOUND_TYPES=true
export DOLBY_DAX_VERSION=1
export DOLBY_DAP2=false
export DOLBY_DAP_SW=true
export DOLBY_DAP_HW=false
export DOLBY_DAP_PREGAIN=true
export DOLBY_DAP_HW_QDSP_HAL_API=false
export DOLBY_DAP_MOVE_EFFECT=true
export DOLBY_DAP_BYPASS_SOUND_TYPES=false
export DOLBY_CONSUMER_APP=true
export DOLBY_UDC_VIRTUALIZE_AUDIO=false
export DOLBY_MONO_SPEAKER=false
